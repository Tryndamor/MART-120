...
function draw ()
{
    ...
    obstacleIce();              // The Ice obstacles
    fallingIce();               // The Ice falling
    obstacleRedEnemy();         // Big Red Enemy
    redEnemyMovement();         // Big Red Enemy movement
    ...
    function obstacleIce()
    {
        fill (0,0,255)
        rect(iceX1,iceY1,20,75) // The Ice itself
        fill (0,0,255)
        rect(iceX2,iceY2,20,75)  // The Ice2 Itself
    }
    function fallingIce()
    {
        iceY1 += iceDirection1; // The Ice falling 
        if( iceY1 >= 900)
            {
             iceY1 = 25
            }
    
        iceY2 += iceDirection2; // The Ice2 Falling
        if( iceY2 >= 900)
            {
             iceY2 = 25
            }
    }
    function obstacleRedEnemy()
    {
        fill (255,0,0);
